...
/*
Test that we are merging adjacent free spaces
*/
...
void test() {
  ...
  void* res3=0;
  res3 = mmap(res2, size + size, 0/*prot*/, 0/*flags*/, -1/*fd*/, 0/*offset*/);
  if (res2<=0)
  {
    printf(1, "XV6_TEST_OUTPUT : mmap failed\n");
    return;
  ...
  if (res3 == res1)
    printf(1, "XV6_TEST_OUTPUT : mmap good, used combined regions\n");
  else
