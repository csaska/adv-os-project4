...
/*
Test that we honor hint when addr fails in middle of a multi page free region
*/
...
void test() {
  ...
  void* res3=0;
  res3 = mmap(res2, size, 0/*prot*/, 0/*flags*/, -1/*fd*/, 0/*offset*/);
  if (res2<=0)
  {
    printf(1, "XV6_TEST_OUTPUT : mmap failed\n");
    return;
  ...
  if (res3 == res2)
    printf(1, "XV6_TEST_OUTPUT : mmap good, honored typehint\n");
  else
    printf(1, "XV6_TEST_OUTPUT : mmap bad, didn't honor typehint\n");
